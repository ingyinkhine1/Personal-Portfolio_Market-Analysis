-- Modifying some table to correct data type 
ALTER TABLE customer_table MODIFY COLUMN customer_acct_num VARCHAR(100);
ALTER TABLE customer_table MODIFY COLUMN birthdate FLOAT;
ALTER TABLE customer_table MODIFY COLUMN acct_open_date FLOAT;
ALTER TABLE product MODIFY COLUMN recyclable VARCHAR(5);
ALTER TABLE product MODIFY COLUMN low_fat VARCHAR(5);
ALTER TABLE Product MODIFY COLUMN product_weight DECIMAL(8, 3) NULL;


-- Creating primary key
ALTER TABLE customer_table MODIFY COLUMN customer_id VARCHAR(10) NOT NULL ,
ADD PRIMARY KEY (`customer_id`);

ALTER TABLE product MODIFY COLUMN product_id VARCHAR(20) NOT NULL ,
ADD PRIMARY KEY (`product_id`);

ALTER TABLE region MODIFY COLUMN region_id VARCHAR(20) NOT NULL ,
ADD PRIMARY KEY (`region_id`);

ALTER TABLE store MODIFY COLUMN store_id VARCHAR(10) NOT NULL ,
ADD PRIMARY KEY (`store_id`);

-- List All data from each table
